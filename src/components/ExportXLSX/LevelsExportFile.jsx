...
const LevelsExportFile = ({ data }) => {
    const flattenData = (data) => {
        return data.map((item) => {
          const flattenedItem = {
            'Surname and First Name': item.Employee.FullName,
      ...
      const generateExcel = async () => {
        ...
        const worksheet = workbook.addWorksheet('Competence levels');
        ...
        worksheet.eachRow((row, rowNumber) => {
            ...
            row.eachCell((cell, cellNumber) => {
                ...
                if(columnName !== 'Surname and First Name' && columnName !== 'Position' && columnName !== 'Supervisor')
                {
