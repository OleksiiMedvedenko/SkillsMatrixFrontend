import { Box, IconButton, useTheme, Typography, InputLabel, Tooltip } from "@mui/material"
            ...
            <Box dispay="flex" style={{display: "inline-table"}}>
                <Box display="flex" 
                    ...
                    <Box display="flex" justifyContent="space-between" alignItems="center" marginTop="10px" marginBottom="10px" >
                        {/* Logo */}
                        <Box ml="15px">
                            <Typography variant="h3" color={colors.greenAccent[500]} style={{fontWeight: "Bold"}}>Simple Soft</Typography>
                        </Box>
                        {/* bar */}
